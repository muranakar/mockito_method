...
// in mockito_method/test/10_verifyInOrder_test.dart.
...
import '10_verifyInOrder_test.dart' as _i2;
...
class MockUserRepository extends _i1.Mock implements _i2.UserRepository {
  ...
  @override
  _i3.Future<void> getUserProfile() =>
      (super.noSuchMethod(
...
class MockNavigationService extends _i1.Mock implements _i2.NavigationService {
  ...
  @override
  _i3.Future<void> navigateTo(String? route) =>
      (super.noSuchMethod(
